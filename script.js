...
mapboxgl.accessToken =
  "pk.eyJ1IjoibGVlY2hpaWlyYWJiaXQiLCJhIjoiY21rY21uaWxlMDJqMDNrc2NjdnY5ZHp3cCJ9.BD21osiOOPkUxPcyuVF_QQ";

// Define a map object by initialising a Map from Mapbox
const map = new mapboxgl.Map({
  container: "map",
  // Replace YOUR_STYLE_URL with your style URL.
  style: "mapbox://styles/leechiiirabbit/cmkmoel7w009f01sg0cddgtm3"
});

map.on("mousemove", (event) => {
  const dzone = map.queryRenderedFeatures(event.point, {
    layers: ["glasgow-simd-4mfema"]
  });
